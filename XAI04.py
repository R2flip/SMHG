...
st.set_page_config(page_title="Understanding the Intention–Behavior Gap XAI System", layout="wide")

st.title("Understanding the Intention–Behavior Gap with Explainable AI")
...
# 2. Prepare data
# -----------------------------
X = data.drop(["Real_CH", "Q76"],axis=1)
y = data["Real_CH"]
